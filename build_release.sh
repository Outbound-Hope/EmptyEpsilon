...
# sudo apt install mingw-w64 cmake make p7zip
# ------
# assuming ~/workspace contains `drmingw-0.8.2-win32`, and `EmptyEpsilon` and `SeriousProton` src projects

#  -DDRMINGW_ROOT="$(pwd)/../../drmingw-0.8.2-win32"
#  -DCMAKE_MAKE_PROGRAM=$(which make) 
cd "$PROJECT_DIR"
rm -rf "_build_win32"
mkdir "_build_win32"
cd "_build_win32"
sudo cmake .. -DCMAKE_MAKE_PROGRAM=$(which make) -DCMAKE_TOOLCHAIN_FILE=../cmake/mingw.toolchain -DSERIOUS_PROTON_DIR=../../SeriousProton -DENABLE_CRASH_LOGGER=1
